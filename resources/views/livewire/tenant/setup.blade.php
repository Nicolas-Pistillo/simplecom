<div>
    <div x-data="{ showSetupModal: false }" x-init="setTimeout(() => showSetupModal = true, 150)" class="relative z-20" aria-labelledby="modal-title"
        ...
        <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
            <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
                <div x-cloak x-show="showSetupModal" x-transition:enter="transition ease-out duration-300"
                    ...
                    transition-all sm:my-8 w-full sm:max-w-lg p-6">
                    ...
                    @if ($currentStep === 'welcome')
                        ...
                        <x-button wire:click='beginSetup' type="primary" class="flex items-center justify-center w-full">
                            Comenzar ahora
                    ...
                    @if ($currentStep === 1)
                        ...
                        <div class="mt-6 flex justify-end border-t border-gray-200 pt-4">
                            <x-button wire:click="submitFirstStep" type="primary" class="flex items-center justify-center w-1/2">
                                Siguiente
                                <x-icon code="arrow_forward" class="ml-4" />
                            </x-button>
                        </div>
                    ...
                    @if ($currentStep === 2)
                        ...
                        <div class="mt-6 grid grid-flow-row-dense grid-cols-2 gap-3 border-t border-gray-200 pt-4">
                            <x-button wire:click='previousStep' type="secondary" class="flex items-center justify-center">
                                <x-icon code="arrow_back" class="mr-4" />
                                Anterior
                            </x-button>

                            <x-button wire:click="submitSecondStep" type="primary" class="flex items-center justify-center">
                                Siguiente
                                <x-icon code="arrow_forward" class="ml-4" />
                            </x-button>
                        </div>
                    ...
                    @if ($currentStep === 3)
                        ...
                        <div class="mt-6 grid grid-flow-row-dense grid-cols-2 gap-3 border-t border-gray-200 pt-4">
                            ...
                            <x-button wire:click="submitThirdStep" type="primary" class="flex items-center justify-center">
                                Finalizar
