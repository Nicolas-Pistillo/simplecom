<div>
    <article class="mb-6">
        <div class="mx-auto max-w-7xl">
            ...
            <div class="flex flex-wrap justify-between mx-auto max-w-2xl gap-3 lg:mx-0 lg:max-w-none">

                <div class="lg:w-2/3 flex flex-col gap-y-6">
                ...
                <div class="lg:w-[31%] flex flex-col gap-y-6">
