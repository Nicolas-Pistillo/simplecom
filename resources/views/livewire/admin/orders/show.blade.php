<div>
    <article class="mb-6">
        <div class="mx-auto max-w-7xl">
            <div class="mx-auto grid max-w-2xl grid-cols-1 grid-rows-1 items-start gap-x-4 gap-y-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                ...
                <!-- Invoice -->
                <div
                    class="-mx-4 px-4 py-8 shadow-sm ring-1 ring-gray-900/5 sm:mx-0 rounded-lg sm:px-8 lg:col-span-2 lg:row-span-2 lg:row-end-2">
                    <h2 class="text-base font-semibold text-gray-900">Pedido {{ $order->reference }}</h2>
                    <dl class="mt-6 grid grid-cols-1 text-sm/6 sm:grid-cols-2">
                        <div class="sm:pr-4">
                            <dt class="inline text-gray-500">Estado</dt>
                    ...
                    <table class="mt-4 w-full whitespace-nowrap text-left text-sm/6">
                        <colgroup>
                            <col class="w-full">
                            <col>
                            <col>
                            ...
                            @if (!empty($feedItem->comments))
                                <li wire:key='{{ $feedItem->id }}' class="relative flex gap-x-4">
                                    ...
                                    @if ($feedItem->presentation === OrderFeedPresentation::Icon)
                                        ...
                                        @php
                                            $iconColor = data_get($feedItem, 'meta.icon_color', 'amber')
                                        @endphp

                                        <div class="flex items-center justify-center rounded-full h-6 w-6 flex-none">
                                            <x-icon :code="data_get($feedItem, 'meta.icon_code', 'notifications')" 
                                    ...
                                    <div class="flex-auto rounded-md p-3 ring-1 ring-inset ring-gray-200">
                                        <div class="flex justify-between gap-x-4">
                                            ...
                                            <time datetime="2023-01-23T15:56" class="flex-none py-0.5 text-xs text-gray-500">
                                                3d ago
                                            </time>
                                        </div>
                                ...
                                <li wire:key='{{ $feedItem->id }}' class="relative flex gap-x-4">
                                    ...
                                    @if ($feedItem->presentation === OrderFeedPresentation::Icon)
                                        ...
                                        <div class="flex items-center justify-center rounded-full h-6 w-6 flex-none">
                                            <x-icon :code="data_get($feedItem, 'meta.icon_code', 'notifications')" 
                                            class="relative border rounded-full p-0.5
                                            bg-{{ $iconColor }}-100 text-{{ $iconColor }}-500 border-{{ $iconColor }}-500 " />
                                        </div>
                                    @endif
                                    ...
                                    <time class="flex-none py-0.5 text-xs/5 text-gray-500">15:34</time>
                                </li>
                            @endif
                        @empty
