    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center mb-8">
            <div class="sm:flex-auto">
                ...
                <p class="mt-2 text-sm text-gray-700">
                    En esta sección podrás configurar tus ubicaciónes o sucursales
        ...
        @if ($store_pickups->isEmpty())
            <div class="text-center mx-auto">
                ...
                <img src="{{ URL::to('img/illustrations/quiet_street.svg') }}" class="h-48 mx-auto"
        ...
        @else
            ...
            <x-modal ref="confirmStorePickupDeletion" type="danger" icon="warning">
                ...
                <x-slot name="actions">
                    ...
                    <x-button wire:click='deleteStorePickup' wire:loading.remove wire:target='deleteStorePickup'
