<div>
    ...
    @else
        <div x-data="{showNotification: false, showBulkDeleteConfirm: false}"
                ...
                <div>
                    ...
                    <ul role="list" class="mb-8">
                        ...
                        @foreach ($products as $product)
                            ...
                            x-data="{showDeleteProductConfirm: false}"
                                ...
                                <div class="flex shrink-0 items-center gap-x-6">
                                    ...
                                    <div class="relative flex-none">
                                        ...
                                        <x-dropdown position="right">
                                            ...
                                            <x-dropdown-item @click="showDeleteProductConfirm = true" 
                                        ...
                                        <x-modal ref="showDeleteProductConfirm" type="danger" icon="warning">
                                            ...
                                            <x-slot name="body">
                                                ¿Estás seguro de que deseas eliminar este producto?, se eliminara toda la información asociada incluidas sus imágenes.
                                            </x-slot>
