<div>
    <div class="relative isolate bg-white">
        <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
            ...
            <section action="#" method="POST" class="px-6 py-16 sm:py-28 lg:px-8">
                <div class="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
                    ...
                    <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                        ...
                        <x-form-input label="Nombre Completo" />

                        <x-form-input type="number" label="Teléfono" />

                        <x-form-input label="Email" class="sm:col-span-full" />
                        ...
                        <div class="sm:col-span-full">
                            ...
                            <div class="w-full border rounded-lg bg-gray-50 border-gray-200">
                                <div class="p-3 bg-white rounded-lg">
                                    <textarea id="product_description" rows="5"
                    ...
                    <div class="mt-8 flex justify-end">
                        <x-button size="large">Enviar consulta</x-button>
                    </div>
                </div>
            </section>
        </div>
