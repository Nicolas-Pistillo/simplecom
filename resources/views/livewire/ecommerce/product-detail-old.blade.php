<div>
    <div x-data class="py-8 lg:py-14 relative overflow-x-hidden">
        ...
        <section class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="mt-10 border-t border-gray-200 pt-8">
                        ...
                        <div class="mt-4">
                            <ul role="list"
                                ...
                                <li class="pl-2">Ancho: 240px</li>
                                <li class="pl-2">Alto: 210px</li>
                                <li class="pl-2">largo: 90px</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            {{-- - Info Tabs --}}
            <div class="mx-auto mt-8 w-full max-w-2xl lg:col-span-4 lg:max-w-none overflow-y-hidden">
                <x-tabs containerClass="!w-full" simple current="Reseñas"
                    tabs="['Reseñas', 'Preguntas Frecuentes', 'Licencia']">

                    <div x-show="current === 'Reseñas'">
                        ...
                        <div class="flex space-x-4 text-sm text-gray-500">
                            ...
                            <div class="border-t border-gray-200 py-10">
                                ...
                                <div class="mt-4 text-sm/6 text-gray-500">
                                    <p>Really happy with look and options of these icons. I've found uses for them
                    ...
                    <div x-show="current === 'Preguntas Frecuentes'" class="text-sm text-gray-500">
                    ...
                    <div x-show="current === 'Licencia'" class="pt-10">
