            ...
            <section aria-labelledby="products-heading" class="pb-24 pt-6">
                ...
                <div class="grid grid-cols-1  gap-x-8 gap-y-10 lg:grid-cols-4">
                    ...
                    @if ($products->isNotEmpty())
                        ...
                        <div wire:loading wire:target='loadProducts, form'>
                            <div class="lg:col-span-3 flex items-center flex-wrap gap-6">
                                @for ($i = 0; $i < 6; $i++)
                                    <div role='status' class='w-[264px] h-max border border-gray-300 rounded-lg p-4'>
                        ...
                        {{-- Products Grid --}}
                        <div wire:loading.remove wire:target='loadProducts, form' 
