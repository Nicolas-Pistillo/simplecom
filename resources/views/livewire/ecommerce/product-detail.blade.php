                        ...
                        <nav class="flex" aria-label="Breadcrumb">
                            <ol role="list" class="flex items-center space-x-2 text-sm">
                                ...
                                @if ($product->category->father?->father)
                                    <li>
                                        <div class="flex items-center">
                                            <a href="{{ $product->category->father->father->pageUrl() }}" class="text-gray-400 hover:text-blue-600 mr-1">
                                ...
                                @if ($product->category->father)
                                    <li>
                                        <div class="flex items-center">
                                            <a href="{{ $product->category->father->pageUrl() }}" class="text-gray-400 hover:text-blue-600 mr-1">
                                ...
                                <li>
                                    <div class="flex items-center">
                                        <a href="{{ $product->category->pageUrl() }}" class="text-gray-400 hover:text-blue-600 mr-1">
                    ...
                    <div x-data="{ currentImage: '{{ $product->first_image }}' }">
                        ...
                        <div class="w-full mx-auto relative mb-6" x-transition>
                            <img x-bind:src="currentImage" alt="product-image"
                                class="w-[400px] h-[250px] sm:w-[500px] sm:h-[450px] rounded-lg shadow-md object-cover">
                        </div>
