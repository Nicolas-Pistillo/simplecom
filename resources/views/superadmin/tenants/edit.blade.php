    ...
    <div class="space-y-10 divide-y divide-gray-900/10 mb-8">
        <div class="grid grid-cols-1 gap-x-8 gap-y-8 pt-10 md:grid-cols-3">
            <div class="px-4 sm:px-0">
                <h2 class="text-base font-semibold leading-7 text-gray-900">Información del comercio</h2>
                <p class="mt-1 text-sm leading-6 text-gray-600">
                    Aca va a ir un poco de info para ayudar a crear el comercio la proxima vez
                </p>
            </div>
