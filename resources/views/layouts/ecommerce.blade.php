...
<head>
    ...
    <script async src="https://maps.googleapis.com/maps/api/js?key={{ env('MAPS_API_KEY') }}&loading=async&libraries=marker&v=3.59" defer></script>
...
<body>
            ...
            <form class="w-full max-w-md lg:col-span-5 lg:pt-2">
                <div class="flex gap-x-4 mb-2">
                    ...
                    <input id="email-address" name="newsletter_email" type="email" required
                        class="min-w-0 flex-auto rounded-md border-0 px-3.5 py-2 shadow-sm ring-1 ring-inset sm:text-sm sm:leading-6"
    ...
    {{-- <div id="web3forms__widget" x-data="{ open: false }">
        <div id="w3f__widget--content" x-show="open" x-transition:enter-start="opacity-0 translate-y-5"
            ...
            class="fixed flex flex-col z-50 bottom-[100px] top-0 right-0 left-0 sm:top-auto sm:right-5 sm:left-auto h-[calc(100%-50px)] w-full sm:w-[350px] overflow-auto min-h-[250px] sm:h-[600px] border border-gray-300 bg-white shadow-2xl rounded-md"
            style="display: none;">
    ...
    <footer class="bg-white border-t border-gray-900/10" aria-labelledby="footer-heading">
        ...
        <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 lg:px-8">
            <div class="xl:grid xl:grid-cols-3 xl:gap-8">
                <div class="space-y-4">
                    <img class="h-20 w-64 object-contain" src="{{ Storage::url(tenant('logo_url')) }}"
