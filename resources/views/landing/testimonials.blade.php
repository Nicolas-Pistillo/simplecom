<section id="testimonials" class="bg-slate-50 relative overflow-hidden">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-32">
        <div class="mx-auto max-w-2xl md:text-center">
            ...
            <p class="mt-4 text-lg tracking-tight text-slate-700">
                Ayudarte a potenciar tu comercio es nuestra prioridad. 
                Descubri cómo nuestra solución ya ha ayudado a negocios como el tuyo.
            </p>
        </div>
        <ul role="list"
