      ...
      <tr>
        <td align="center" class="sm-px-4" style="background-color: #f8fafc">
          <table class="sm-w-full" style="width: 640px" cellpadding="0" cellspacing="0" role="none">
            ...
            <tr>
              <td align="left" class="sm-p-6" style="border-radius: 8px; background-color: #fffffe; padding: 24px 36px; border: 1px solid #e2e8f0">
                <div style="margin-bottom: 32px; text-align: center">
                  <a href="https://example.com">
                    <img src="https://simplecom-ecommerce.s3.sa-east-1.amazonaws.com/franchi/FDPVnj5vTkD7sV4aAnVpjqGrFRUoeDofmBhSdThb.png" alt="Shop Name" width="180" style="max-width: 100%; vertical-align: middle">
                  </a>
                </div>
                <p style="margin-bottom: 24px; margin-top: 0; font-size: 24px; line-height: 32px; font-weight: 600; color: #0f172a">
                  Hi Candy
                </p>
                <p style="margin: 0; font-size: 16px; line-height: 24px; color: #475569">
                  Thank you for your purchase!
                  We have received your order <a href="https://example.com" class="hover-text-decoration-underline">&#8470; 1234</a>.
                ...
                <table style="width: 100%" cellpadding="0" cellspacing="0" role="none">
                  <tr>
                    <td style="width: 72px; vertical-align: top">
                      <img src="https://simplecom-ecommerce.s3.sa-east-1.amazonaws.com/franchi/products/4/mlYlaQqBlxn9J8m8VACAYb5RSS4FrBrb3fblASBA.jpg" alt="Aviator sunglasses" width="48" style="max-width: 100%; vertical-align: middle; border-radius: 8px">
                    </td>
                ...
                <table style="width: 100%" cellpadding="0" cellspacing="0" role="none">
                  <tr>
                    <td style="width: 72px; vertical-align: top">
                      <img src="https://simplecom-ecommerce.s3.sa-east-1.amazonaws.com/franchi/products/8/yMrjySLGPFGmdxQUcxr6EmJqVfuvum7S43POLGsk.jpg" alt="Fancy smartwatch" width="48" style="max-width: 100%; vertical-align: middle; border-radius: 8px">
                    </td>
                    <td class="sm-w-auto" style="width: 400px; text-align: left; vertical-align: top; font-size: 16px; color: #111827">
