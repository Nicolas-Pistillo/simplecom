                            ...
                            @if ($i % 2 === 0)
                                <li class="relative flex gap-x-4">
                                    ...
                                    <div class="flex items-center justify-center rounded-full h-6 w-6 flex-none">
                                        <x-icon code="location_on" class="relative bg-blue-100 text-blue-500 border-blue-500 
                                    ...
                                    <time datetime="2023-01-24T09:12" class="flex-none py-0.5 text-xs/5 text-gray-500">La semana pasada</time>
                                </li>
                            @else
                                <li class="relative flex gap-x-4">
                                    ...
                                    @if ($i === 5)
                                        <div class="flex items-center justify-center rounded-full h-6 w-6 flex-none">
                                            <x-icon code="check" class="relative bg-green-100 text-green-500 border-green-500 
                                            border rounded-full p-0.5" />
                                        </div>
                                    @else
                                    ...
                                    <div class="flex-auto rounded-md p-3 ring-1 ring-inset ring-gray-200">
                                        ...
                                        <p class="text-sm/6 text-gray-500">Called client, they reassured me the invoice would be
                                            paid by the 25th.</p>
                                    </div>
