...
@section('content')
    ...
    <x-tabs tabs="['General', 'Comercio']" current="General">
        ...
        <section x-show="current == 'General'" x-cloak x-transition.opacity>
            <div class="space-y-12 sm:space-y-16">
                <div>
                    <div class="mt-4 space-y-8 border-b border-gray-900/10 pb-12 sm:space-y-0 sm:divide-y sm:divide-gray-900/10 sm:pb-0">
