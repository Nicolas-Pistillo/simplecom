...
@section('content')
    <div class="mx-auto max-w-7xl lg:flex lg:gap-x-16 lg:px-8 py-10">
        ...
        lg:block lg:w-64 lg:flex-none lg:border-b-0 mb-8 lg:mb-0 border-r">
            <nav class="flex-none px-4 sm:px-6 lg:px-0">
                <ul role="list" class="flex gap-x-3 gap-y-1 whitespace-nowrap lg:flex-col">
                    ...
                    <li>
                        <a href="#" class="group flex items-center gap-x-3 rounded-md bg-gray-50 
                        py-2 pl-2 pr-3 text-sm/6 font-semibold text-blue-600">
                    ...
                    <li>
                        ...
                        rounded-md py-2 pl-2 pr-3 text-sm/6 font-semibold text-gray-700 
                    ...
                    <li>
                        <a href="#" class="group flex items-center gap-x-3 rounded-md py-2 pl-2 pr-3 
                        text-sm/6 font-semibold text-gray-700 hover:bg-gray-50 
                        hover:text-blue-600">
                    ...
                    <li>
                        <a href="#"
                            class="group flex items-center gap-x-3 rounded-md py-2 
                            pl-2 pr-3 text-sm/6 font-semibold text-gray-700 
                            hover:bg-gray-50 hover:text-blue-600">
        ...
        <main class="px-4 sm:px-6 lg:flex-auto lg:px-0">
            <div class="mx-auto max-w-2xl space-y-16 sm:space-y-20 lg:mx-0 lg:max-w-none">
                <div>
                    ...
                    <p class="mt-1 text-sm/6 text-gray-500">This information will be displayed publicly so be careful what
                        you share.</p>
