...
@section('content')
  ...
  <div class="mx-auto max-w-7xl lg:flex lg:gap-x-16 lg:px-8 py-16">
        ...
        <ul role="list" class="flex gap-x-3 gap-y-1 whitespace-nowrap lg:flex-col">
          <li>
            ...
            <a href="#" class="group flex gap-x-3 rounded-md bg-gray-50 py-2 pl-2 pr-3 text-sm/6 font-semibold text-indigo-600">
              <svg class="w-8 h-8 shrink-0 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
          ...
          <li>
            <a href="#" class="group flex gap-x-3 rounded-md py-2 pl-2 pr-3 text-sm/6 font-semibold text-gray-700 hover:bg-gray-50 hover:text-indigo-600">
              <svg class="w-8 h-8 shrink-0 text-gray-400 group-hover:text-indigo-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
            ...
            <div class="flex pt-6">
              ...
              <dd class="flex flex-auto items-center justify-end">
                ...
                <button type="button" class="flex w-8 cursor-pointer rounded-full bg-gray-200 p-px ring-1 ring-inset ring-gray-900/5 transition-colors duration-200 ease-in-out focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600" role="switch" aria-checked="true" aria-labelledby="timezone-option-label">
                  ...
                  <span aria-hidden="true" class="w-8 h-8 translate-x-0 transform rounded-full bg-white shadow-sm ring-1 ring-gray-900/5 transition duration-200 ease-in-out"></span>
                </button>
              </dd>
            </div>
          </dl>
