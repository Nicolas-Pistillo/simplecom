<div class="mx-auto max-w-7xl px-4 py-8 lg:px-8">
    <div class="flex items-center justify-between gap-x-4 mb-8">
        ...
        <div class="flex justify-center items-center">
            ...
            <x-icon id="new-arrivals-prev-btn" code="navigate_before" 
            class="no-select p-2 rounded-full border-2 hover:bg-gray-200/60 
            transition-colors duration-300"
            />

            <x-icon id="new-arrivals-next-btn" code="navigate_next" 
    ...
    <div class="w-full relative">
        <div id="new-arrivals-slider" class="swiper swiper-container relative">
            <div class="swiper-wrapper flex relative w-full h-max no-select">
                ...
                <a href="#" class="swiper-slide rounded-2xl relative group overflow-hidden w-96 h-96">
                    <img src="https://smartpressblog.imgix.net/wp-content/uploads/2024/05/types-of-banners.jpg?auto=format%2Ccompress&ixlib=php-3.3.0&s=e036120ec1e2bee8900021714acfb13f" alt="men with t-shirt"
