                        ...
                        <div x-data="{ open: false }" class="relative inline-block text-left">
                            <div>
                                <button @click="open = !open" type="button"
                                    class="group inline-flex justify-center text-sm font-medium 
                            ...
                            <div x-show="open" x-cloak @click.away="open = false" x-show="open"
                                x-transition:enter="transition ease-out duration-200"
                                x-transition:enter-start="opacity-0 scale-90"
                                x-transition:enter-end="opacity-100 scale-100"
                                x-transition:leave="transition ease-in duration-100"
                                x-transition:leave-start="opacity-100 scale-200"
                                x-transition:leave-end="opacity-0 scale-90"
                                class="absolute right-0 mt-2 z-10 w-40 origin-top-right rounded-md 
                                bg-white shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none"
                                role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                                <ul class="py-1" role="none">
                                    <li class="font-medium text-gray-500 block px-4 py-2 text-sm 
                                    cursor-pointer hover:text-black transition duration-200 hover:bg-gray-50"
                                    role="menuitem" tabindex="-1" id="menu-item-0">Most Popular</li>
                    ...
                    <div class="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                        ...
                        <form class="hidden lg:block">
                            ...
                            <div x-data="{open: false}" class="border-b border-gray-200 py-6">
                                ...
                                <!-- Filter section, show/hide based on section state. -->
                                <div x-show="open" x-cloak x-collapse.duration.300 class="pt-6" id="filter-section-0">
                                    <div class="space-y-4">
                                        <div class="flex items-center">
