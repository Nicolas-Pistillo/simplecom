...
enum ShippingStatus: string
{
    ...
    public function helper(): string
    {
        return match($this)
        {
            ...
            ShippingStatus::LastTrace          => 'En envío se encuentra en el último tramo del recorrido',
            ShippingStatus::Confirmed          => 'La orden de envío se ha confirmado correctamente',
            ShippingStatus::InBranch           => 'El pedido llegó a la sucursal de destino, el comprador puede pasar a retirarla',
    ...
    public function customerHelper(): string
    {
        return match($this)
        {
            ...
            ShippingStatus::LastTrace          => 'Tu pedido está en el ultimo tramo del recorrido',
